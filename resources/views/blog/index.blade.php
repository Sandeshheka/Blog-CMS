                    ...
                    <article class="post-item">
                        ...
                        <div class="post-item-body">
                            <div class="padding-10">
                                <h2><a href="{{route('blogShow', $post->slug)}}">{{$post->title}}</a></h2>
                                ...
                                <div class="pull-left">
                                    <ul class="post-meta-group">
                                       <li><i class="fa fa-user"></i><a href="{{route('author', $post->author->slug)}}"> {{$post->author->name}}</a></li> 
                                        ...
                                        <li><i class="fa fa-comments"></i><a href="{{route('blogShow', $post->slug)}}#post-comments ">{{$post->commentsNumber()}}</a></li>
                                    </ul>
                                </div>
                                <div class="pull-right">
                                    <a href="{{route('blogShow', $post->slug)}}">Continue Reading &raquo;</a>
                                </div>
                            </div>
                        </div>
                    </article>
