                        ...
                        <div class="widget-body">
                            ...
                            @foreach($popularPosts as $post)
                                <li>
                                    ...
                                    @endif
                                    <div class="post-body">
                                        <h6><a href="{{route('blogShow', $post->slug)}}">{{$post->title}}</a></h6>
                                        <div class="post-meta">
                                            <span>{{$post->date}}</span>
                                        </div>
                                    </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            @foreach($archives as $archive)
                                <li><a href="{{route('blogIndex', ['month' => $archive->month, 'year' => $archive->year]) }}">{{month_name($archive->month) . " " . $archive->year}}</a>
